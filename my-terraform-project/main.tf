terraform {
  backend "s3" {
    bucket= "enis-terraform-for-state-file-0125-6735d762"  # Replace with your S3 bucket name
...
resource "aws_s3_object" "private_key_object" {
  bucket                  = "enis-terraform-for-state-file-0125-6735d762"  # Reference existing S3 bucket
